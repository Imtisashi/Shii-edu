...
module.exports = async function privacyPolicy(req, res) {
  ...
  const description = 'Privacy commitments for Shii-Edu covering student records, institute data, payments, media, transport data, and India DPDP Act aligned processing.';
  ...
  const sections = [
    {
      ...
      body: [
        'This Privacy Policy explains how Shii-Edu processes information for schools, colleges, administrators, teachers, students, parents, drivers, and platform operators.',
        'Institutes remain responsible for the accuracy, lawful basis, and administrative use of the education records they create. Shii-Edu acts as a technology platform and processor for institute-managed data unless a separate written agreement states otherwise.',
      ],
    },
    {
      id: 'data-collected',
      ...
      body: [
        'Shii-Edu may process account identifiers, institute IDs, role assignments, attendance records, grades, routines, notices, assignments, fee records, uploaded documents, profile pictures, institute logos, transport route information, support metadata, and security logs.',
    ...
    },
    {
      ...
      body: [
        'Shii-Edu uses authentication, institute IDs, role-based authorization, Row-Level Security policies, API authorization checks, signed uploads, and environment-secret separation to reduce unauthorized access risk.',
    ...
    },
    {
      ...
      body: [
        'Shii-Edu may use infrastructure and service providers including hosting, database, authentication, storage, analytics, notification, payment, AI, and communication providers.',
        'Third-party services operate under their own security and privacy terms. Shii-Edu is not responsible for independent third-party acts outside the platform operator direct control, except where applicable law provides otherwise.',
      ],
    },
    {
      id: 'liability',
      ...
      body: [
        'To the maximum extent permitted by law, Shii-Edu and its platform operator are not liable for indirect, incidental, special, consequential, exemplary, or punitive damages arising from institute administrative decisions, transport operations, third-party processors, network failures, user credential compromise, or inaccurate data entered by institute personnel.',
    ...
    },
    {
      ...
      title: 'Contact',
      body: [
        'Privacy and security requests should be sent through the official Shii-Edu support or administrator contact channel provided to the institute.',
