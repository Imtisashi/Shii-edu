...
module.exports = async function termsOfService(req, res) {
  ...
  const description = 'Edu-shii Terms of Service for institute-managed education administration, payments, uploads, AI assistance, transport workflows, and workspace access.';
  ...
  const sections = [
    ...
    },
    {
      ...
      body: [
        'Edu-shii may change, suspend, or discontinue features to improve security, performance, compliance, or reliability.',
