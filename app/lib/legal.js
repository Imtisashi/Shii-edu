...
export const privacySections = [
  ...
  },
  {
    ...
    body: [
      'Shii-Edu uses authentication, institute IDs, role-based authorization, PostgreSQL Row-Level Security policies, API authorization checks, signed uploads, and environment-secret separation to reduce unauthorized access risk.',
