    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
           ...
           >
             <View style={[styles.heroGradient, layout.isDesktop && styles.heroGradientDesktop, { backgroundColor: 'rgba(15, 23, 42, 0.85)' }]}>
        ...
        <View style={[styles.bodyContent, layout.isDesktop && styles.bodyContentDesktop, layout.isDesktop && { maxWidth: layout.maxContentWidth }]}>
          ...
          <View style={[styles.gridContainer, layout.isDesktop && styles.gridContainerDesktop]}>
            <PremiumActionCard columns={layout.dashboardColumns} compact={layout.isCompact} title="Students" icon="people" color="#3B82F6" bgColor="#EFF6FF" delay={100} onPress={() => navigation.navigate('Users')} />
            <PremiumActionCard columns={layout.dashboardColumns} compact={layout.isCompact} title="Faculty" icon="briefcase" color="#8B5CF6" bgColor="#F5F3FF" delay={200} onPress={() => navigation.navigate('ManageTeachers')} />
            <PremiumActionCard columns={layout.dashboardColumns} compact={layout.isCompact} title="Master Routine" icon="calendar" color="#E11D48" bgColor="#FFE4E6" delay={300} onPress={() => navigation.navigate('ManageRoutines')} />
            <PremiumActionCard columns={layout.dashboardColumns} compact={layout.isCompact} title="Revenue" icon="wallet" color="#10B981" bgColor="#ECFDF5" delay={400} onPress={() => navigation.navigate('Ledger')} />
            <PremiumActionCard columns={layout.dashboardColumns} compact={layout.isCompact} title="Broadcast" icon="megaphone" color="#F59E0B" bgColor="#FFFBEB" delay={500} onPress={() => navigation.navigate('Broadcasts')} />
            <PremiumActionCard columns={layout.dashboardColumns} compact={layout.isCompact} title="Calendar" icon="calendar-number" color="#64748B" bgColor="#F1F5F9" delay={600} onPress={() => navigation.navigate('ManageHolidays')} />
          </View>
